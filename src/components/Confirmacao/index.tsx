...
import { Button, CartContainer, Overlay, Sidebar, Textos } from './style'
...
const Confirmacao= ({  })=>{
    const {  isPedidoProcessadoOpen } = useSelector((state: RootReducer) => state.cart);
    ...
    return(
        <>
            <CartContainer className={isPedidoProcessadoOpen ? 'is-open-confirmaco' : ''}>
