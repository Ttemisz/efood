...
import { Button, CartContainer, CepNumero, InputGroup, Overlay, Sidebar } from "./style"
import { closeEntrega, open, openPagamento, setDelivery } from '../../store/reducers/cart'
